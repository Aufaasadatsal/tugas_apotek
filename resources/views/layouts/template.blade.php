            ...
            <div class="container">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                  ...
                  <li>
                    <a class="nav-link active dropdown-toggle navbar-dark" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      Obat
                    </a>
                  ...
                  @else
                  <li class="nav-item">
                    <a class="nav-link active navbar-dark" aria-current="page" href="{{ route('kasir.order.index') }}">Pembelian</a>
                  </li>
                  @endif 
                  <li class="nav-item">
                    <a href="{{ route('logout') }}" class="nav-link active navbar-dark">Logout</a>
                  </li>
                  @endif
                </ul>
              </div>
